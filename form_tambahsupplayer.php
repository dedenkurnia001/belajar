          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="fungsi_tambahsupplayer.php">
                  <input type="hidden" name="username" value="<?php echo $username; ?>">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama supplayer</label>
                      <input type="text" name="nama_supplayer" class="form-control" id="exampleInputEmail1" placeholder="nama supplayer">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">nomer telpon</label>
                      <input type="text" name="notelpon" class="form-control" id="exampleInputPassword1" placeholder="nomer telpon" onkeypress="return hanyaAngka(event)">
                    </div>
                    <div class="form-group">
