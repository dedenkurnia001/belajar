          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="fungsi_tambahdataadmin.php">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama</label>
                      <input type="text" name="username" class="form-control" id="exampleInputEmail1" placeholder="Nama">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="hak_akses" class="form-control" id="exampleInputPassword1" placeholder="Hak akses">
                    </div>
                  </div>
                  <!-- /.card-body -->
