              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="box-header">
                    <br><a class="btn btn-success" href="form_tambahdata.php">Tambah Data</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          {document.location='fungsi_hapus.php?nama=<?php echo $c['nama']; ?>';}">
                              <i class="fa fa-trash"></i></a> &nbsp;
                            <a href="javascript:
                          {document.location='form_ubahdata.php?nama=<?php echo $c['nama']; ?>';}">
