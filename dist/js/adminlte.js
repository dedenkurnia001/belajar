...
(function (global, factory) {
  ...
  var Default$c = {
    ...
    responseType: "",
    overlayTemplate:
      '<div class="overlay"><i class="fa fa-2x fa-sync-alt fa-spin"></i></div>',
  ...
  var IFrame = /*#__PURE__*/ (function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newNavItem =
        '<li class="nav-item" role="presentation"><a href="#" class="btn-iframe-close" data-widget="iframe-close" data-type="only-this"><i class="fa fa-times"></i></a><a class="nav-link" data-toggle="row" id="' +
        navId +
        '" href="#' +
        tabId +
