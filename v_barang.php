            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">DataTable data barang</h3>
                  <div class="box-header">
                    <br><a class="btn btn-success" href="form_tambahbarang.php">Tambah Data</a>
                  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $a = "select * from tabel_barang where deleted_at is null";
