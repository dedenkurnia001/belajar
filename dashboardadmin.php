                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="box-header">
                                        <br><a class="btn btn-success" href="form_tambahdataadmin.php">Tambah Data</a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $c['hak_akses']; ?></td>
                                                    <td>
                                                        <a href="javascript:if(confirm('Yakin ingin menghapus data?'))
                                                        {document.location='fungsi_hapusadmin.php?username=<?php echo $c['username']; ?>';}">
                                                            <i class="fa fa-trash"></i></a> &nbsp;
                                                        <!-- <a href="javascript:
                                                        {document.location='form_ubahdataadmin.php?username=<?php echo $c['username']; ?>';}">
